<footer class="short" id="footer">
						...
						<div class="col-md-3 col-md-offset-1">
							...
							<ul class="list list-icons mt-xl">
								...
								<li>
									...
									<strong>Email:</strong> 
									<a href="mailto:mail@example.com"><?php echo $ayarcek['ayar_mail']; ?></a>
								</li>
							</ul>
						</div>
						<div class="col-md-3">
				...
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<p>© Copyright 2022. All Rights Reserved. | <a href="demo-law-firm-contact-us.html"><?php echo $ayarcek['ayar_author']; ?></a></p>
							</div>
						</div>
					</div>
				</div>
